# This is to change the previous version of export GUI
# into the new version that users can export the data they selected

# Also, this program will raise a messagebox once the user choose no data from the listbox (to remind)
from tkinter import *
...
class History:
    def __init__(self, partner, calc_history):
        ...
        # as the calculation history is displayed from the most recent one to the least recent datas
        # Therefore, I reverse the elements of the list to make sure that the history will be exported in the right order
