# this version is to add a message box to remind the user while temperature entered is grater than 100000
# Also, for flexibility, I have added a "delete" function to make to make sure that the entry box will
# cleared once the user pressed any of the buttons "to centigrade" and "to fahrenheight"
from tkinter import *
