"""This is the fifth integrated version of the temperature convertor, in this version, I have adjusted some code based on the feedback that others have given."""
# This version are fixed the error on...
# 1. The incorrect units on the generated trend graph.

# This version also adjusted some function...
# 1. The time of the countdown function has been adjusted into 5 seconds instead of 30 seconds
# 2. The screen size of the instruction GUI (for trailling)
