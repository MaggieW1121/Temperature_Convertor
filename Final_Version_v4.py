"""This is the fouth integrated version of temperature convertor."""
# This version adjusted the following functions...
# 1. the disablility of generate trend graph button
# 2. Accept the filename in alphabets/numbers/symbols
# 3. Accept the filename end with .txt
# 4. Reject the filename end with other form except .txt (ie .csv)
# 5. Set the state into 'Disable' once the file is successfully exported

# From feedback given by the tester, I have adjusted...
# 1. whitespace error in the texts
# 2. disable the entry box while in the other GUI
...
class Convertor:
    ...
    def help(self):
        ...
        get_help.help_text.configure(text="Please enter a number in the box "
                                     ...
                                     "You are allow to choose any calculation history and generate a temperature trend graph. "
